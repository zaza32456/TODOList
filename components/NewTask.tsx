...
export const NewTask = ({setEdit, title, description, rank, isFinish, addTask, inputTitle, inputDescription}) => {
  // console.log(title)
  return (
    <>
      <div className={`${styles.createTask}`}>
        ...
        <div className={`${styles.title}`} >
          <input type="text" onChange={inputTitle} value={title} placeholder='准备做什么?' ></input>
        ...
        <div onClick={addTask} className={`${styles.save}`}>保 存</div>
